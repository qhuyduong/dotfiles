...
augroup file_types
    ...
    autocmd BufRead,BufNewFile *.txt set filetype=markdown expandtab tabstop=4 softtabstop=4 shiftwidth=4
    ...
    autocmd BufRead,BufNewFile *.c,*.h set filetype=c noexpandtab tabstop=8 softtabstop=8 shiftwidth=8
augroup END
