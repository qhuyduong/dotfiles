...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-themes
   '(
     (base16-oceanicnext-dark :location local)
     )
   ...
   dotspacemacs-mode-line-theme '(vim-powerline :separator arrow)
